    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-dark-950 px-4 py-16 sm:py-20">
        ...
        <div className="relative mx-auto max-w-4xl">
          <Link href="/sauna" className="mb-6 inline-flex items-center gap-2 text-sm text-dark-400 transition-colors hover:text-brand-400">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-extrabold text-white sm:text-4xl">Regras da Sauna</h1>
              <p className="mt-1 text-dark-400">Leia atentamente antes de utilizar nosso espaço</p>
            </div>
          </div>
        </div>
      </section>
