...
import { ArrowLeft, Shield, Clock, Shirt, Droplets, Heart, MessageCircle, Wine, Wrench, Ban, ShieldCheck, CreditCard, AlertTriangle, UserCheck } from 'lucide-react';
...
export const metadata = {
  ...
  description: 'Confira todas as regras, orientações e termos de utilização da sauna e piscina.',
};
...
const SECTION_COLORS: Record<string, string> = {
  'HORÁRIO': 'bg-blue-100 text-blue-600',
  'REGISTRO': 'bg-purple-100 text-purple-600',
  'CÓDIGO': 'bg-pink-100 text-pink-600',
  'HIGIENE': 'bg-cyan-100 text-cyan-600',
  'COMPORTAMENTO': 'bg-red-100 text-red-600',
  'BEBIDAS': 'bg-amber-100 text-amber-600',
  'INSTALAÇÕES': 'bg-orange-100 text-orange-600',
  'PROIBIÇÕES': 'bg-slate-100 text-slate-600',
  'SEGURANÇA': 'bg-green-100 text-green-600',
  'PAGAMENTO': 'bg-emerald-100 text-emerald-600',
  'RESPONSABILIDADE': 'bg-rose-100 text-rose-600',
  'SANÇÕES': 'bg-dark-100 text-dark-600',
};
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-dark-500">Leia atentamente antes de utilizar nosso espaço</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 mt-1">Ao utilizar o Sauna e Espaço da Janice, você declara ter lido e compreendido todas as regras abaixo e concorda em cumpri-las integralmente.</p>
            </div>
          </div>
        </div>
      </section>
